                ...
                <div id="gradient">
                    <div class="search-container"  id="rcorners">
                        <form action="/action_page.php">
                            <input type="text" placeholder="Search.." name="search" style = "font-size:15px; padding-left:10px;">
                    ...
                    <img src="Pop-Up logo2.svg" style="padding:370px; padding-top: 100px; margin-bottom: -90px;">
                    <form action="action_page.php" style = "margin-top: -200px; margin-bottom: -20px; padding-bottom: 20px; padding-left: 575px;">
