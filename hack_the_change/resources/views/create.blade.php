                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card rounded-3">
                        ...
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Please, release anything that you have in yur mind here </h3>
                            ...
                            <form method="post" action="{{route('topic.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Titile of your subject</label>
                                    <input type="text"
                                           name="title"
                                           class="form-control" id="title" aria-describedby="emailHelp" placeholder="Enter title">
                                    <small id="emailHelp" class="form-text text-muted">Write your favorite title (less than 50 letters)</small>
                                </div>


                                <button type="submit" class="btn btn-primary">Release it!</button>
                            </form>
